  ...
  <default-layout>
    <base-page>
        ...
        <section class="legal">
            <slim-column>
                <section class="text">
                    <g-image src="~/assets/images/container.jpeg" alt="Container ship"></g-image>
                    <h1 class="title">Términos y Condiciones</h1>
                    <p>Este apartado describe los términos y condiciones generales aplicables al uso de los contenidos, productos y servicios ofrecidos a través del sitio <strong>www.kafa-logistics.com</strong>, del cual es titular <strong>Kafá Logistics</strong>, quien tiene su domicilio establecido en Baja California, en la siguiente dirección:</p>
                    <p>Calle 2da y Granada Local #9. CP 22830. Ensenada, B.C., México</p>
                    ...
                    <p>Dada la naturaleza de la actividad desarrollada por el TITULAR, se hace de su conocimiento que el mismo se encuentra registrado ante Secretaría de Hacienda y Crédito Público y cuenta con el número de autorización <strong>KF-0000-B0</strong>, mediante el cual le es permitido llevar a cabo las siguientes actividades: dar soluciones logísticas en el transporte aéreo, marítimo y terrestre de mercancías desde y hacia cualquier parte del mundo; trabajar como facilitadores en las cadenas de suministro de nuestros clientes y socios comerciales, proporcionando de manera oportuna soluciones logísticas.
                    </p>

                    <h2>I. DEL OBJETO</h2>
                    <p>El objeto de los presentes TÉRMINOS Y CONDICIONES es regular el acceso y la utilización del SITIO WEB, entendiendo por este cualquier tipo de contenido, producto o servicio que se encuentre a disposición del público en general dentro del dominio: <strong>www.kafa-logistics.com</strong>.</p>
                    <p>El TITULAR se reserva la facultad de modificar en cualquier momento y sin previo aviso, la presentación, los contenidos, la funcionalidad, los productos, los servicios, y la configuración que pudiera estar contenida en el SITIO WEB; en este sentido, el USUARIO reconoce y acepta que <strong>Kafá Logistics</strong> en cualquier momento podrá interrumpir, desactivar o cancelar cualquiera de los elementos que conforman el SITIO WEB o el acceso a los mismos.</p>
                    ...
                    <p>El acceso a los contenidos y servicios facilitados a través del SITIO WEB no requerirá de suscripción o registro alguno.</p>
                    <p>El SITIO WEB se encuentra dirigido exclusivamente a personas que cuenten con la mayoría de edad (mayores de 18 años); en este sentido,<strong> Kafá Logistics</strong> declina cualquier responsabilidad por el incumplimiento de este requisito.</p>
                    <p>El SITIO WEB está dirigido principalmente a USUARIOS residentes en la República Mexicana, por lo cual, <strong>Kafá Logistics</strong> no asegura que el SITIO WEB cumpla total o parcialmente con la legislación de otros países, de forma que, si el USUARIO reside o tiene su domicilio establecido en otro país y decide acceder o utilizar el SITIO WEB lo hará bajo su propia responsabilidad y deberá asegurarse de que tal acceso y navegación cumple con la legislación local que le es aplicable, no asumiendo <strong>Kafá Logistics</strong> ninguna responsabilidad que se pueda derivar de dicho acto.</p>
                    ...
                    <p><strong>Kafá Logistics</strong> se reserva el derecho de retirar todos aquellos comentarios y aportaciones que vulneren la ley, el respeto a la dignidad de la persona, que sean discriminatorios, atenten contra los derechos de tercero o el orden público, o bien, que a su juicio no resulten adecuados para su publicación.</p>
                    <p>En cualquier caso, <strong>Kafá Logistics</strong> no será responsable de las opiniones vertidas por los USUARIOS a través de comentarios o publicaciones que estos realicen.</p>
                    ...
                    <p>El TITULAR no garantiza de ningún modo la continuidad y disponibilidad de los contenidos, productos o servicios ofrecidos a través del SITIO WEB, no obstante, el TITULAR llevará a cabo las acciones que de acuerdo a sus posibilidades le permitan mantener el buen funcionamiento del SITO WEB, sin que esto suponga alguna responsabilidad de parte de <strong>Kafá Logistics</strong>.</p>
                    <p>De igual forma <strong>Kafá Logistics</strong> no será responsable ni garantiza que el contenido o software al que pueda accederse a través del SITIO WEB, se encuentre libre de errores, software malicioso, o que pueda causar algún daño a nivel de software o hardware en el equipo a través del cual el USUARIO accede al SITIO WEB.</p>
                    <p>El TITULAR tampoco se hace responsable de los daños que pudiesen ocasionarse por un uso inadecuado del SITIO WEB. En ningún caso <strong>Kafá Logistics</strong> será responsable por las pérdidas, daños o perjuicios de cualquier tipo que surjan por el sólo acceso o utilización del SITIO WEB.</p>
                    ...
                    <p>El tratamiento de datos personales se limitará al cumplimiento de las finalidades previstas en el <strong>Aviso de Privacidad</strong> el cual se encontrará disponible en la siguiente dirección electrónica: <strong>www.kafa-logistics.com</strong></p>

                    <p>El SITIO WEB podrá incluir hipervínculos o enlaces que permitan acceder a páginas web de terceros distintos de <strong>Kafá Logistics</strong>. Los titulares de dichos sitios web dispondrán de sus propias políticas de privacidad y protección de datos, por lo cual <strong>Kafá Logistics</strong> no asume ningún tipo de responsabilidad por los datos que san facilitados por el USUARIO a través de cualquier sitio web distinto a <strong>www.kafa-logistics.com</strong>.</p>

                    <p><strong>Kafá Logistics</strong> se reserva el derecho a modificar su Política de Privacidad, de acuerdo a sus necesidades o derivado de algún cambio en la legislación. El acceso o utilización del SITIO WEB después de dichos cambios, implicará la aceptación de estos cambios.</p>
                    ...
                    <p>La utilización de estos enlaces, contenidos, servicios o funciones, tiene por objeto mejorar la experiencia del USUARIO al hacer uso del SITIO WEB, sin que pueda considerarse una sugerencia, recomendación o invitación para hacer uso de sitios externos. <strong>Kafá Logistics</strong> en ningún caso revisará o controlará el contenido de los sitios externos, de igual forma, no hace propios los productos, servicios, contenidos, y cualquier otro material existente en los referidos sitios enlazados; por lo cual, tampoco se garantizará la disponibilidad, exactitud, veracidad, validez o legalidad de los sitios externos a los que se pueda tener acceso a través del SITIO WEB. Así mismo, el TITULAR no asume ninguna responsabilidad por los daños y perjuicios que pudieran producirse por el acceso o uso, de los contenidos, productos o servicios disponibles en los sitios web no gestionados por <strong>Kafá Logistics</strong> a los que se pueda acceder mediante el SITIO WEB.</p>

                    <h2>VI. POLÍTICA EN MATERIA DE PROPIEDAD INTELECTUAL E INDUSTRIAL.</h2>
                    <p><strong>Kafá Logistics</strong> por sí o como parte cesionaria, es titular de todos los derechos de propiedad intelectual e industrial del SITIO WEB, entendiendo por este el código fuente que hace posible su funcionamiento así como las imágenes, archivos de audio o video, logotipos, marcas, combinaciones de colores, estructuras, diseños y demás elementos que lo distinguen. Serán, por consiguiente, protegidas por la legislación mexicana en materia de propiedad intelectual e industrial, así como por los tratados internacionales aplicables. Por consiguiente, queda expresamente prohibida la reproducción, distribución, o difusión de los contenidos del SITIO WEB, con fines comerciales, en cualquier soporte y por cualquier medio, sin la autorización de <strong>Kafá Logistics</strong>.</p>
                    ...
                    <p>La relación entre el USUARIO y Kafá Logistics se regirá por la legislación vigente en México, específicamente en Baja California. De surgir cualquier controversia en relación a la interpretación y/o a la aplicación de los presentes TÉRMINOS Y CONDICIONES, las partes se someterán a la jurisdicción ordinaria de los tribunales que correspondan conforme a derecho en el estado al que se hace referencia.</p>
